...
const BrandingIcon: React.FC<Props> = ({ className }) => {
  return (
    <svg className={className} fill="#000000" width="800px" height="800px" viewBox="0 0 16 16" id="puzzle-16px" xmlns="http://www.w3.org/2000/svg">
