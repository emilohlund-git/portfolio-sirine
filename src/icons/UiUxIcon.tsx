...
const UiUxIcon: React.FC<Props> = ({ className }) => {
  return (
    <svg className={className} fill="#000000" width="800px" height="800px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
      <title>pen</title>
